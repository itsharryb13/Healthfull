...
export default function SignInNavBar() {
  ...
  return(
    <nav className='flex w-full h-[4vw] main-containerNav relative mx-auto'>
        ...
        <div className = 'w-[13vw] h-[4vw] mx-auto absolute top-[.4vw] left-3 overflow-hidden'>
                <Link href="/">
        ...
        <div className='flex w-[15vw] h-[2vw] gap-x-5 items-center flex-nowrap absolute top-[1vw] right-[1.8vw]'>
            ...
            <Link href="../Registration" className='flex h-[95%] justify-center items-right grow shrink-0 basis-0 flex-nowrap bg-button rounded-lg border-solid border border-[#2c2c2c] relative overflow-hidden'>
                <button className="h-full shrink-0 basis-auto font-['Inter'] lg:text-lg font-normal leading-lg text-[#f5f5f5] relative text-center whitespace-nowrap z-[6] bg-button">
                    <span >
                        Register
                    </span>
                </button>
